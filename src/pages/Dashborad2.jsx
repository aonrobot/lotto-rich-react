            ...
            <div className='DashBorad d-flex flex-column h-100'>
                ...
                <div className='pickerCard d-flex flex-column card mx-3 mt-3 pb-3'>
                    ...
                    <div className='d-flex flex-row mr-3'>
                        <div className='d-flex mx-3' style={{flex:1}}>
                            <input type="text" className="form-control text-right" placeholder="กรุณาระบุจำนวนเงิน..."/>
                        </div>
                        <div style={{flex:0}}>
                            <button type="button" className="btn btn-warning" onClick={this.handleClick}> เพิ่ม </button>
                        </div>
                    </div>
                </div>
                {/* Select List */}
                ...
                <div className='d-flex'>
                    <button type="button" className="btn btn-success w-100 m-2" style={{flex:1}} onClick={this.handleClick}> สั่งซื้อ </button>
                </div>
            </div>
        )
    }
